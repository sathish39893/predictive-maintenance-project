...
engine_data = pd.read_csv(DATASET_PATH)
...
y = engine_data[target]


# Load training and test data set from Hugging face dataset repo

Xtrain = pd.read_csv("hf://datasets/sathish39893/predictive-maintenance-data/Xtrain.csv")
Xtest = pd.read_csv("hf://datasets/sathish39893/predictive-maintenance-data/Xtest.csv")
ytrain = pd.read_csv("hf://datasets/sathish39893/predictive-maintenance-data/ytrain.csv")
ytest = pd.read_csv("hf://datasets/sathish39893/predictive-maintenance-data/ytest.csv")
